...
Inititally, I was researching to find out how much people are willing to spend on staying in other people's homes and the effect it has had on hotels, but due to the fact I could not find data that could answer that question I decided to take another route. I'm predicting that the location and reviews of a listing have an effect on the price of it. I, also, believe that private rooms have better reviews than other listings. 
...
new_york_fields <- tibble ( 
  ...
  reviews_per_month = new_york$fields$reviews_per_month,
  ...
  maximum_nights = new_york$fields$maximum_nights,
  host_since = new_york$fields$host_since,
  neighbourhood_group_cleansed = new_york$fields$neighbourhood_group_cleansed,
  last_review = new_york$fields$last_review,
  number_of_reviews = new_york$fields$number_of_reviews,
  host_id = new_york$fields$host_id,
  host_total_listings_count = new_york$fields$host_total_listings_count,
...
If we also take into consideration the model's p-value, we see that it is less than 2.2e^-6 meaning there is clearly 